...
interface AddRetailerFormProps {
    onSubmit: (retailer: string) => Promise<void>;
    
}

const AddRetailerForm: React.FC<AddRetailerFormProps> = ({ onSubmit }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Pressable style={styles.button} onPress={handleRetailerSubmit} > 
